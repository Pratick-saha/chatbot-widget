...
(function () {
    ...
    window.handleInput = function () {
      ...
      if (message) {
        ...
        if (msg.includes("course")) response = "We offer B.Tech, BCA, MBA, MCA.";
        else if (msg.includes("student login")) response = "Visit: https://institute.edu/student-login";
        else if (msg.includes("faculty login")) response = "Visit: https://institute.edu/faculty-login";
        else if (msg.includes("stream")) response = "Available streams: CS, EC, ME, CE";
